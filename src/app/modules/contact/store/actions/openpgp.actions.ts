...
const OPENPGP_LOAD_PUBLIC_KEY = '[OpenPGP] Load Public Key';
const OPENPGP_LOAD_PUBLIC_KEY_SUCCESS = '[OpenPGP] Load Public Key Success';
const OPENPGP_LOAD_PUBLIC_KEY_FAILURE = '[OpenPGP] Load Public Key Failure';
